...
export default class PrevButton extends ArrowButton {

    constructor(parent: Object, canvas: Canvas, onclick: (e?: IEvent) => (void | Promise<void>)) {
        super(parent, canvas, onclick, 180);
    }
    ...
    protected getRelativePosition(): Point {
        ...
        const point = new fabric.Point(pdfObjWidth / 2 - rectWidth * 2.25, -pdfObjHeight/2 - rectWidth * 1.25);
        return point;
    }
}